...
public class WebPageConnection
{
    ...
    public void onMessage(String message) 
    {
        ...
        connectionManager.enqueueMessage(message, this);
       
    }
    
    /** Fired when a client sends a binary message. We don't handle these
     * for now.
     *
    ...
    {
       System.out.println("JSONRepeater does not handle binary messages");
